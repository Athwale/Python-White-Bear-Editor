...
class SpellCheckSetupDialog(wx.Dialog):
    ...
    def __init__(self, parent) -> None:
        ...
        self._label_provider = wx.StaticText(self, -1, Strings.label_dictionary_location + ': ')
        self._content_provider = wx.StaticText(self, -1, Strings.label_none)
        self._dictionary_sub_sizer.Add(self._label_provider, flag=wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL)
        self._dictionary_sub_sizer.Add(self._content_provider, flag=wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL)
        ...
        self._language_list = wx.ComboBox(self, -1, choices=enchant.list_languages(),
        ...
        print(Path(enchant.get_user_config_dir() / Path(self._checker.lang)))
